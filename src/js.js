...
$(document).ready(function () {
    ...
    for (var i = 1; i <=k; i++)
        text[k-i] = '<figure style="display:block;"><img src="images/2017/0' + i + '.jpg" alt="" onload="this.parentNode.style.display = "block"" /><figcaption id="title' + i + '"></figcaption></figure>'
    $('#images').html(text);     
});    
