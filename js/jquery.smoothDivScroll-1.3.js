...
(function ($) {
	...
	$.widget("thomaskahn.smoothDivScroll", {
		...
		options: {
			...
			easingAfterHotSpotScrollingDistance: 20, // Pixels
		...
		**********************************************************/
		...
		showHotSpotBackgrounds: function () {
            var self = this, el = this.element, o = this.options;
				...
				el.data("scrollingHotSpotLeft").add(el.data("scrollingHotSpotRight")).fadeIn(200);

			self._showHideHotSpots();
        },

		hideHotSpotBackgrounds: function () {
			var el = this.element, o = this.options;

                el.data("scrollingHotSpotLeft").addClass(o.scrollingHotSpotLeftVisibleClass);
                el.data("scrollingHotSpotRight").addClass(o.scrollingHotSpotRightVisibleClass);

                el.data("scrollingHotSpotLeft").add(el.data("scrollingHotSpotRight")).fadeOut(200);
        },
